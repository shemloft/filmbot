...
//
//	public TelegramChatBot(Map<Field, Map<String, List<Film>>> filmMapsByField) {
...
//
//		TelegramBot bot = new TelegramBot(filmMapsByField, BOT_USERNAME, BOT_TOKEN, botOptions);
//
//		try {
