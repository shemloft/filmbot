...
public class BotTest {
	...
	public void setUp() throws Exception {
		...
		IState state1 = new TestState(new Messages(new BotMessage("answer1", new String[0])), "state1", StateType.DIALOG);
		IState state2 = new TestState(new Messages(new BotMessage("answer2", new String[0])), "state2", StateType.ANSWER);
