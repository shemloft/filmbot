...
public class FilmTest extends TestCase {
	...
	public void testGetField() throws KeyException {
	...
	public void testEquals() {
		...
		Assert.assertEquals(false, film1==film2);
		Assert.assertEquals(true, film1==film3);
		Assert.assertEquals(false, film2 == film3);
